...
public interface MovieRepository extends JpaRepository<Movie, Long> {
    ...
    List<Movie> findByPriceBetween(BigDecimal lower, BigDecimal higher);
    ...
    List<Movie>findBySomeRangeOfPrices(BigDecimal lower, BigDecimal upper);
